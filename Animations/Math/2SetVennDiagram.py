# TITLE: Venn Diagram: Sets A & B
# DESCRIPTION: Step-by-step construction of two overlapping sets showing individual regions and their intersection within universal set.
from manim import *
...
class VennDiagramAB(Scene):
    def construct(self):
        ...
        circle_A = Circle(radius=1.5, color=color_A,
                          fill_opacity=0.5).shift(LEFT * 1.2)
        circle_B = Circle(radius=1.5, color=color_B,
                          fill_opacity=0.5).shift(RIGHT * 1.2)
