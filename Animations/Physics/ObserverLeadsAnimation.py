# TITLE: Doppler Effect: Source Chasing Animation
# DESCRIPTION: Scenario of Doppler effect where source chases(lags behind) observer.
from manim import *
config.frame_width = 16
config.frame_height = 9


class SourceChasinAnimation(Scene):
    def construct(self):
        Scenario_1 = Text(
            "1. Source follows observer: Source chasing", font_size=45).shift(UP*1.5)
        Scenario_1.set_color_by_gradient(
