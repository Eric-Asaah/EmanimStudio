# TITLE: Doppler Effect Formula: f' = f((v+vₒ)/(v-vₛ))
# DESCRIPTION: Doppler effect equation showing observed frequency change when source and observer approach each other.
from manim import *
